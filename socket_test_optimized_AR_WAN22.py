...
# =========================================================================
# MONKEY PATCH: FORCE OFFLINE MODE FOR --local-dir CHECKPOINTS
# Includes routing to support the Wan2.2 split architecture
# =========================================================================
...
def offline_hf_hub_download(*args, **kwargs):
    ...
    if repo_id and filename:
        if "Wan2.2" in repo_id or "Wan2.2" in str(filename):
            local_dir = os.path.abspath("./checkpoints/Wan2.2-TI2V-5B")
        elif "Wan" in repo_id or "Wan2.1" in str(filename):
...
class Args:
    ...
    model_path: str = "./checkpoints/dreamzero_droid_wan22_lora" # Points to new LoRA output
    wan22_path: str = "./checkpoints/Wan2.2-TI2V-5B" 
    wan21_path: str = "./checkpoints/Wan2.1-I2V-14B-480P" 
...
def main(args: Args) -> None:
    ...
    # =========================================================================
    # UPDATED: Split architecture mappings for Wan2.2
    # =========================================================================
    local_overrides = {
        "action_head_cfg.config.diffusion_model_cfg.diffusion_model_pretrained_path": args.wan22_path,
        "action_head_cfg.config.vae_cfg.vae_pretrained_path": args.wan22_path,
        "action_head_cfg.config.image_encoder_cfg.image_encoder_pretrained_path": args.wan21_path,
